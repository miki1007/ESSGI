...
/*
  ...
  one the user logs in successfully they are redirected to the home page

  if they don't have an account, they are redirected to the register page
 */
